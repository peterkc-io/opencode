...
import { DiagnosticsProvider } from "../../../../src/context/diagnostics"
import { disabled, type TuiDiagnostics } from "../../../../src/diagnostics/service"
...
export async function mount(override?: FetchHandler, state?: string, diagnostics: TuiDiagnostics = disabled) {
